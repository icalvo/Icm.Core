...
namespace Gekka.Roslyn.Translator.VB2CSTrans
{
    partial class VB2CS
    {
        #region Declaration
        ...
        static VBS.NamespaceBlockSyntax ConvertNamespaceDeclaration(this CSS.NamespaceDeclarationSyntax node)
        {
            ...
            return VB.SyntaxFactory.NamespaceBlock(vbNamespaceStatement, vbmembers.ConvertToSyntaxList());
        }
        ...
        static VBS.EnumBlockSyntax ConvertEnumDeclaration(this CSS.EnumDeclarationSyntax node)
        {
            ...
            return VB.SyntaxFactory.EnumBlock(vbEnumStatement, vbMembers);
        }
        ...
        static VBS.MethodBlockSyntax ConvertDestructor(this CSS.DestructorDeclarationSyntax node)
        {
            ...
            return VB.SyntaxFactory.SubBlock(vbSubStatement, vbStatements);
        }
        ...
        static VB.VisualBasicSyntaxNode ConvertLambdaExpression(this CSS.LambdaExpressionSyntax node)
        {
            ...
            {
                var vbStatements = ((CSS.BlockSyntax)csLambda.Body).Statements.ConvertSyntaxNodes<VBS.StatementSyntax>();
        ...
        class SearchReturnWalker : CS.CSharpSyntaxWalker
        {
        ...
        static VBS.WithBlockSyntax ConvertBlock(CSS.BlockSyntax node)
        {
            ...
            if (csBlock.Parent.IsKind(CS.SyntaxKind.Block) || csBlock.Parent.IsKind(CS.SyntaxKind.SwitchSection))
            {
        ...
        static VBS.MultiLineIfBlockSyntax ConvertIfStatement(this CSS.IfStatementSyntax node)
        {
            ...
            var vbIfThen = VB.SyntaxFactory.IfStatement(vbCondition).WithThenKeyword(VB.SyntaxFactory.Token(VB.SyntaxKind.ThenKeyword));
        ...
        static VBS.WithBlockSyntax ConvertFor(this CSS.ForStatementSyntax node)
        {
            ...
            var vbIf = VB.SyntaxFactory.MultiLineIfBlock(VB.SyntaxFactory.IfStatement(vbCondition));
            vbIf = vbIf.AddStatements(VB.SyntaxFactory.ExitForStatement());
        ...
        static VBS.LabelStatementSyntax ConvertLabel(this CSS.LabeledStatementSyntax node)
        {
            ...
            return VB.SyntaxFactory.LabelStatement(vbID.ToFullString());
        }
        ...
        static VBS.ReturnStatementSyntax ConvertReturn(this CSS.ReturnStatementSyntax node)
        {
            ...
            return VB.SyntaxFactory.ReturnStatement(vbExpression);
        }
        ...
        static VBS.YieldStatementSyntax ConvertYield(this CSS.YieldStatementSyntax node)
        {
            ...
            return VB.SyntaxFactory.YieldStatement(vbExpression);
        }
        ...
        static VBS.EnumMemberDeclarationSyntax ConvertEnumMemberDeclaration(this CSS.EnumMemberDeclarationSyntax node)
        {
            ...
            return VB.SyntaxFactory.EnumMemberDeclaration(vbAttributes, vbID, vbEqualsValue);
        ...
        static VBS.EventStatementSyntax ConvertEventFieldDeclaration(this CSS.EventFieldDeclarationSyntax node)
        {
            ...
            var vbEvent = VB.SyntaxFactory.EventStatement(vbDeclarator.Names[0].GetText().ToString())
        ...
        static VBS.PropertyBlockSyntax ConvertIndexer(this CSS.IndexerDeclarationSyntax node)
        {
            ...
            SyntaxToken vbID = VB.SyntaxFactory.Identifier(CS.SyntaxFactory.Token(CS.SyntaxKind.ThisKeyword).ToFullString());
        ...
        {
            public SyntaxList<VBS.AttributeListSyntax> Others = new SyntaxList<VBS.AttributeListSyntax>();
            public SyntaxList<VBS.AttributeListSyntax> Return = new SyntaxList<VBS.AttributeListSyntax>();
        }
        ...
        static VBS.NullableTypeSyntax ConvertNullableType(this CSS.NullableTypeSyntax node)
        {
            ...
            var vbElementType = (VBS.PredefinedTypeSyntax)csNullType.ElementType.Convert();
        ...
        static SyntaxToken ConvertID(this SyntaxToken csID)
        {
            if (csID.IsKind(CS.SyntaxKind.IdentifierToken))
            {
                ...
                if (!(csID.Parent is CSS.MethodDeclarationSyntax) && IsVBKeyword(id))
                {
        ...
        static VBS.ExpressionSyntax ConvertControlChar(char c)
        {
            if (Char.IsControl(c))
            {
                for (int i = 0; i < ControlCharPairs.GetLength(0); i++)
                {
                    ...
                    {
                        var vbToken = VB.SyntaxFactory.CharacterLiteralToken(ControlCharPairs[i, 1], c);
        ...
        static VBS.SimpleArgumentSyntax ConvertArgument(this CSS.ArgumentSyntax node)
        {
            ...
            var vbArg = VB.SyntaxFactory.SimpleArgument(vbExp);
            return vbArg;
        }
        ...
        static SeparatedSyntaxList<VBS.ExpressionSyntax> ConvertExpressions(this SeparatedSyntaxList<CSS.ExpressionSyntax> csExps)
        {
            SeparatedSyntaxList<VBS.ExpressionSyntax> retval = new SeparatedSyntaxList<VBS.ExpressionSyntax>();
            var vbExps = csExps.Select(csExp => csExp.Convert() as VBS.ExpressionSyntax).Where(vbExp => vbExp != null);
