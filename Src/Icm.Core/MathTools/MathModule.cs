...
namespace Icm.MathTools
{
	public static class MathModule
	{
		...
		{
		    return a.Concat(new[] {double.NegativeInfinity}).Max();
		}
        
		public static bool NearEqual(this double d1, double d2, double precission)
		{
		...
		{
			return a.Concat(new[] {long.MinValue}).Max();
		}
	}
}