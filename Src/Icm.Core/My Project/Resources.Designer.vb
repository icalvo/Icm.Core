...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a Already exists a {0} with name {1}.
        '''</summary>
        Friend ReadOnly Property ALREADY_EXISTS() As String
            Get
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a Not yet implemented.
        '''</summary>
        Friend ReadOnly Property NOT_IMPLEMENTED() As String
            Get
